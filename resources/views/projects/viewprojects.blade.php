        ...
        <div class="container-fluid">
            <div class="row" id="projectsContainer">
                ...
                @php
                    ...
                    // Auto-Close Logic if Date Passed
                    if ($status !== 'draft' && $endDate && $today->greaterThan($endDate)) {
                        $status = 'closed'; // Visually treat as closed/completed
                    }

                    // --- 2. TIMELINE BAR CALCULATION ---
                    $timePercentage = 0;
                    ...
                    <div class="card project-card shadow-sm mb-3"
                        ...
                        <div class="card-body p-0">
                            <div class="row no-gutters align-items-center" style="min-height: 110px;">
                                ...
                                {{-- === CENTER: CHARTS & TIMELINE (50%) === --}}
                                {{-- Removed border-right --}}
                                <div class="col-md-6 p-3">
                                    <div class="row align-items-center">
                                        
                                        {{-- 1. PIE CHART (Budget vs Spent) --}}
