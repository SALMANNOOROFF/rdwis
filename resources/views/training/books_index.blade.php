                ...
                <div class="col-md-12">
                    <div class="d-flex bg-white p-2 border border-secondary" style="border-radius: 12px; background: var(--rd-neutral-200) !important;">
                        <div class="input-group input-group-sm mr-2" style="max-width: 300px;">
                            ...
                            <input type="text" class="form-control bg-transparent border-0 text-dark" placeholder="Search by title, author or ISBN...">
                        </div>
                                ...
                                @foreach($books as $book)
                                    <tr class="book-row" style="transition: all 0.2s ease;">
                                        ...
                                        <td class="py-3 align-middle">
                                            <span class="badge extra-small px-2 py-1" style="background: var(--rd-neutral-200); color: var(--rd-text1); border: 1px solid var(--rd-border2); font-weight: 600;">{{ $book['department'] }}</span>
                                        </td>
                                        <td class="py-3 align-middle">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content border-0 shadow-lg" style="background: var(--rd-surface); border-radius: 20px;">
            <div class="modal-header border-0 text-center d-block pt-4">
                ...
                <h4 class="modal-title font-weight-bold w-100 text-dark" id="modalBookName">Clean Code</h4>
            ...
            <div class="modal-body px-4 pb-4">
                <div id="borrowForm">
                    <div class="form-group">
                        ...
                        <select class="form-control bg-white border-secondary text-dark">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control bg-white border-secondary text-dark" rows="2" placeholder="e.g. Research for upcoming project..."></textarea>
                    </div>
