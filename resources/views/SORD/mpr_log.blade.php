                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <span class="font-weight-bold" style="color: var(--rd-accent);">{{ $log->document->project->prj_code ?? 'N/A' }}</span>
                                    <br>
                                ...
                                <td class="align-middle small">
                                    @if($log->fromUser)
                                        <div class="font-weight-bold" style="color: var(--rd-text1);">{{ $log->fromUser->role->rol_desig ?? 'Unknown Role' }}</div>
                                        <div class="text-xs" style="color: var(--rd-text3);">{{ $log->fromUser->acc_username }}</div>
                                    @else
