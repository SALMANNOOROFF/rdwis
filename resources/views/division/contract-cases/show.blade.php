                    ...
                    @else
                        ...
                        <div class="clean-card">
                            ...
                            <div class="p-4 text-center">
                                ...
                                <p class="text-muted small mb-1">Currently undergoing review with:</p>
                                <h6 class="font-weight-bold text-dark mb-3">{{ $case->currentSubstatus->display_name ?? $case->ctc_status }}</h6>
