...
<style>
    ...
    .btn-action-primary:hover { background: var(--rd-primary-600); }
    ...
    <section class="content">
        <div class="dark-contract-wrapper">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('md.contract-cases.index') }}" class="btn-back"><i class="fas fa-arrow-left mr-2"></i> Back to Hub</a>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="premium-card">
                        ...
                        <div class="p-4 text-center">
                            <a href="{{ Storage::url($cv->cat_path) }}" target="_blank" style="color: var(--rd-primary-600); text-decoration: none;">
                ...
                <div class="col-md-4">
                    <div class="premium-card action-card">
                        <div class="premium-card-header">Executive Actions</div>
                        <div class="p-4">
                            @if($case->ctc_status == 'Under Approval')
                                <button class="btn-action-primary btn-action" data-url="{{ route('md.contract-cases.approve', $case->ctc_id) }}" data-msg="Finalize and approve this contract case?"><i class="fas fa-check-double mr-2"></i> Final Approve</button>
                                <button class="btn-action-danger btn-action" data-url="{{ route('md.contract-cases.return', $case->ctc_id) }}" data-msg="Return Case due to objections?"><i class="fas fa-undo mr-2"></i> Return Case</button>
                            @else
                                <div class="text-center">
                                    <i class="fas fa-lock fa-2x mb-2 text-secondary"></i>
                                    <p style="color: var(--rd-text3); font-size: 0.9rem;">No pending actions for Executive Approval.</p>
                                </div>
                            @endif
                        </div>
                    </div>
...
$(document).ready(function() {
    $('.btn-action').click(function() {
        ...
        Swal.fire({
            ...
            confirmButtonColor: 'var(--rd-primary-600)',
                    ...
                    success: function(res) {
                        if(res.success) {
                            Swal.fire('Success', res.message, 'success').then(() => {
                                window.location.href = "{{ route('md.contract-cases.index') }}";
                            });
                        }
                    }
                });
