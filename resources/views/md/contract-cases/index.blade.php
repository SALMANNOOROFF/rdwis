...
<div class="content-wrapper fin-page pt-4">
    <div class="container-fluid px-4">
        ...
        <div class="row align-items-center mb-4">
            <div class="col-md-7">
                <span class="badge px-3 py-1 mb-2 rajdhani" style="font-size: 10px; background: rgba(139, 92, 246, 0.1); color: #8b5cf6; border: 1px solid rgba(139, 92, 246, 0.2);">EXECUTIVE AUTHORITY</span>
                <h1 class="font-weight-bold text-white rajdhani m-0" style="font-size: 2.2rem;">Managing Director Dashboard</h1>
                <p class="text-muted mb-0 small">Final executive review and approval authority for all contract cases.</p>
            </div>
            <div class="col-md-5 text-right">
                <div class="d-inline-block metric-card p-3 text-left mr-2" style="border-right: 4px solid #8b5cf6;">
                    <div class="metric-label">Approval Queue Value</div>
                    <div class="metric-value" style="color: #8b5cf6;">PKR {{ number_format($actionReqCases->sum('ctc_newsalary')) }}</div>
                </div>
        ...
        <div class="metric-card overflow-hidden">
            <div class="p-3 bg-dark d-flex justify-content-between align-items-center" style="background: #0f161e !important;">
                <h6 class="m-0 rajdhani text-white font-weight-bold"><i class="fas fa-crown mr-2" style="color: #8b5cf6;"></i> EXECUTIVE APPROVAL QUEUE</h6>
                <div class="text-muted small rajdhani">TOTAL PENDING CASES: <span class="text-white">{{ $actionReqCases->count() }}</span></div>
            </div>
                ...
                <table class="table dg-case-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="text-white small font-weight-bold">{{ $p->ctc_empnamecomp }} ({{ $p->ctc_newjobtitle }})</div>
                            ...
                            <td class="text-right font-weight-bold rajdhani" style="font-size: 16px; color: #8b5cf6;">Rs. {{ number_format($p->ctc_newsalary) }}</td>
                            <td class="text-right pr-4">
                                <a href="{{ route('md.contract-cases.show', $p->ctc_id) }}" class="btn btn-sm rounded-pill px-3 rajdhani font-weight-bold text-white" style="font-size: 11px; background: #8b5cf6; border-color: #8b5cf6;">
