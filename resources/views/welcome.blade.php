  ...
  <head>
    ...
    <style>
        ...
        /* Hide Layout Elements when inside iframe */
        html.in-iframe .main-header,
        html.in-iframe .main-sidebar,
        html.in-iframe .main-footer,
        html.in-iframe .content-header,
        html.in-iframe .accordion-custom,
        html.in-iframe .preloader,
        html.in-iframe #rdwisDebugConsole,
        html.in-iframe .btn-outline-secondary i.fa-arrow-left { /* Hide back buttons in iframes */
            display: none !important;
        }
        html.in-iframe .content-wrapper {
    ...
    <script>
        if (window.self !== window.top) {
            ...
            document.addEventListener("DOMContentLoaded", function() {
                document.querySelectorAll('a.btn i.fa-arrow-left, a.btn i.fa-arrow-circle-left').forEach(function(icon) {
                    var btn = icon.closest('a.btn');
...
{{-- Hiding Old Purchase System as requested --}}
          ...
          <li class="nav-item">
              <a href="{{ route('reports.center') }}" class="nav-link {{ Request::routeIs('reports.center') ? 'active' : '' }}">
