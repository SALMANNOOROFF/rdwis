    ...
    <div class="container-fluid px-4">
        ...
        <div style="margin-bottom:20px; background: linear-gradient(to right, #0f172a, transparent); padding: 20px; border-radius: 12px;">
            <div class="d-flex justify-content-between align-items-center mb-2">
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{ route('nrdi.purchase_cases_new.index') }}" class="dg-back-btn">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                {{-- Decision History --}}
                @include('approvals_new._decision_trail')
            </div>
            ...
            <div class="col-md-4">
                ...
                <div style="position: sticky; top: 20px;">
                    <div class="glass-card mb-4" style="border: 2px solid rgba(59,130,246,0.3);">
                        <div class="card-title-bar" style="background: rgba(59,130,246,0.08);">
                            <span class="rajdhani text-white font-weight-bold"><i class="fas fa-gavel mr-2 text-primary"></i> Decision Hub: Review & Action</span>
                        </div>
                        <div class="card-body">
