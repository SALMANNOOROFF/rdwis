    ...
    <section class="content">
        <div class="contract-page-wrapper">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-3">
                ...
                <a href="{{ route('finance.contract-cases.index') }}" class="btn-back-link">
                    <i class="fas fa-arrow-left"></i> Back to Finance Queue
                </a>
            </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="clean-card">
                        <div class="clean-card-header">
                            <span><i class="fas fa-file-invoice-dollar mr-2 text-primary"></i> Financial Terms & Budget Impact</span>
                    ...
                    @if($case->current_stage === 'Finance')
                        ...
                        <div class="clean-card" style="border: 1.5px solid var(--rd-primary-600); box-shadow: 0 4px 16px rgba(95, 120, 88, 0.12);">
                            <div class="clean-card-header bg-light">
                                <span><i class="fas fa-calculator mr-2 text-primary"></i> Finance Budget Scrutiny</span>
                            </div>
                            <div class="p-4">
                                ...
                                <button type="button" class="btn-action-forward" id="btn-forward-md">
                                    <i class="fas fa-arrow-right"></i> Forward to MD
                                </button>
...
$(document).ready(function() {
    ...
    $('#btn-forward-md').click(function() {
        const rem = $('#finRemarks').val();
        if (!rem) {
            Swal.fire('Required', 'Please provide budget scrutiny remarks before forwarding.', 'warning');
            return;
        }

        Swal.fire({
            title: 'Forward to MD',
            text: 'Are you sure you want to endorse and forward this case to the Managing Director?',
            icon: 'question',
    ...
    // ── Return Case (with target stage selection) ─────────────
