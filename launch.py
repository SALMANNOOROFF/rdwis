...
log(f"Opening {OPEN_URL} in standalone mode...")
# Using 'start' to ensure Windows finds Edge correctly
cmd = f'start msedge --app={OPEN_URL} --window-size=1280,800 --no-first-run'
subprocess.Popen(cmd, shell=True)

log("Application is now running as a standalone window.")
time.sleep(5)