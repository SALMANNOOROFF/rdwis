...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('force_password_change')->group(function () {
        ...
        Route::get('/reports-center', [ReportsController::class, 'reportsCenter'])->name('reports.center');
        Route::get('/reports/hr/incomplete-data', [ReportsController::class, 'hrIncompleteData'])->name('reports.hr.incomplete_data');
        Route::get('/reports/hr/grades', [ReportsController::class, 'hrGrades'])->name('reports.hr.grades');
        Route::get('/reports/hr/qualifications', [ReportsController::class, 'hrQualifications'])->name('reports.hr.qualifications');
        Route::get('/reports/hr/current-employees', [ReportsController::class, 'hrCurrentEmployees'])->name('reports.hr.current_employees');
        Route::get('/reports/hr/ex-servicemen', [ReportsController::class, 'hrExServicemen'])->name('reports.hr.ex_servicemen');
        Route::get('/reports/hr/salaries-paid', [ReportsController::class, 'hrSalariesPaid'])->name('reports.hr.salaries_paid');
        Route::get('/reports/hr/custom', [ReportsController::class, 'hrCustom'])->name('reports.hr.custom');
        Route::get('/reports/finance/allocation-status', [ReportsController::class, 'finAllocationStatus'])->name('reports.finance.allocation_status');
        Route::get('/reports/finance/account-status', [ReportsController::class, 'finAccountStatus'])->name('reports.finance.account_status');
        Route::get('/reports/finance/proj-shares-status', [ReportsController::class, 'finProjSharesStatus'])->name('reports.finance.proj_shares_status');
        Route::get('/reports/finance/subheads-status', [ReportsController::class, 'finSubheadsStatus'])->name('reports.finance.subheads_status');
        Route::get('/reports/finance/csrf-status', [ReportsController::class, 'finCsrfStatus'])->name('reports.finance.csrf_status');
        Route::get('/reports/finance/pcs-awaiting-payment', [ReportsController::class, 'finPcsAwaitingPayment'])->name('reports.finance.pcs_awaiting_payment');
        Route::get('/reports/inventory/shared-assets', [ReportsController::class, 'invSharedAssets'])->name('reports.inventory.shared_assets');
