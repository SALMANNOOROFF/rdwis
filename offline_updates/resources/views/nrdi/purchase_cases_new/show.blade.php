                ...
                <div class="dg-right">
                    ...
                    <div class="dg-panel-r mt-3">
                        <div class="dg-panel-r-hdr py-2 px-3">
                            <span class="dg-panel-r-title" style="font-size: 11px;"><i class="fas fa-check-circle mr-1"></i> Recent Approved Cases</span>
                        </div>
                        <div class="dg-trail-body p-0" style="max-height: 300px;">
                            <table class="dg-items-table" style="font-size: 10px;">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr class="cursor-pointer" onclick="window.location='{{ route('nrdi.purchase_cases_new.show', $rc->pcs_id) }}'">
                                        <td class="pl-3 text-muted">{{ $ri + 1 }}</td>
                                        <td>
                                            <div class="text-white font-weight-bold" style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 140px;">{{ $rc->pcs_title }}</div>
