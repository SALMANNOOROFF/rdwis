...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Report_fin_headstatusall_open_subheads_a_div"
...
Private Sub cmdSubheadWise_Click()
DoCmd.OpenReport "fin_headstatusall_open_subheads_b_div", acViewReport
DoCmd.Close acReport, "fin_headstatusall_open_subheads_a_div"
End Sub
