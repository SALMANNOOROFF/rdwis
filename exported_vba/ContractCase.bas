...
intResponse = MsgBox("The case will be forwarded to Finance Department. Are you sure you want to release this case?", vbExclamation + vbYesNo, "Release Confirmation")
If intResponse <> 6 Then Exit Sub

frmRel!ctc_status = "Under HR Scrutiny"
...
Screen.ActiveForm!ctc_status = "Approved"
DoCmd.Close
End Sub
...
intResponse = MsgBox("The case will be closed and a new contract will be created. Do you want to proceed?", vbExclamation + vbYesNo, "Release Confirmation")
If intResponse <> 6 Then Exit Sub
...
If frm!ctc_approvedstartdt <> DateAdd("d", 1, frm.subContract.Form!ctr_enddt) Then
    ...
    With rstAppCC
        .Edit
        !ctr_enddt = DateAdd("d", -1, frm!ctc_approvedstartdt)
...
intResponse = MsgBox("The case will closed and the contract will be extended. Do you want to proceed?", vbExclamation + vbYesNo, "Release Confirmation")
If intResponse <> 6 Then Exit Sub
