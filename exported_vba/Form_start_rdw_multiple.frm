...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_start_rdw_multiple"
...
Select Case Me.frmChoose
    Case 1
        Me.cmdAccounts.Visible = True
        Me.cmdAccStatusDetails.Visible = True
        Me.cmdAccStatusMtss.Visible = True
        ...
        Me.frmChoose.Left = 1600
    Case 2
        Me.cmdAccounts.Visible = False
        Me.cmdAccStatusDetails.Visible = False
        Me.cmdAccStatusMtss.Visible = False
...
dtToday = GetNow()
SetOneDayAttendanceSql FirstDateThisMonth(dtToday), Day(dtToday)
...
DoCmd.OpenReport "hr_attendance_u_oneday_summary", acViewReport
