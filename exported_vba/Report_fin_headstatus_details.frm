...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Report_fin_headstatus_details"
...
Me.lblTax.Caption = Forms!fin_headstatus_details.lblTax.Caption
...
'Visibilities
If Forms!fin_headstatus_details.prj_share.Visible = False Then Me.prj_share.Visible = False
If Forms!fin_headstatus_details.prj_exp.Visible = False Then
...
For n = 1 To 5
    If Forms!fin_headstatus_details.Controls("prj_exp_" & Chr(n + 96)).Visible = False Then
        Me.Controls("prj_name_" & Chr(n + 96)).Visible = False
        Me.Controls("prj_alloc_" & Chr(n + 96)).Visible = False
        Me.Controls("prj_exp_" & Chr(n + 96)).Visible = False
        Me.Controls("prj_commit_" & Chr(n + 96)).Visible = False
        Me.Controls("prj_canbespent_" & Chr(n + 96)).Visible = False
        Me.Controls("box_" & Chr(n + 96)).Visible = False
        End If
    Next n
End Sub
