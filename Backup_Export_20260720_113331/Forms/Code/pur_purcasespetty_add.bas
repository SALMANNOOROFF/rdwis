...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_pur_purcasespetty_add"
...
If IsNull(Me!pcs_frm_id) Then
    MsgBox "Please enter firm name", vbCritical
    Exit Sub
    End If
...
DoCmd.OpenForm "pur_purcasespetty_detail", acNormal, , , , acHidden, Me!pcs_status & "~" & Me!pcs_id
DoCmd.Close acForm, "pur_purcasespetty_add"
End Sub
