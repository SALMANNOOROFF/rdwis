...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_pur_purcases_add"
...
DoCmd.OpenForm "pur_purcases_detail", acNormal, , , , acHidden, Me!pcs_status & "~" & Me!pcs_id
DoCmd.Close acForm, "pur_purcases_add"
End Sub
